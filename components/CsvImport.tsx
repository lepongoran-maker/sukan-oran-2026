...
import { HouseColor, Gender, Participant, EventLimitsConfig, EventType, SystemConfig } from '../types';
...
const CsvImport: React.FC<CsvImportProps> = ({ onBulkRegistration, onBulkOverride, eventLimits, existingRegistrations = {}, systemConfig = DEFAULT_SYSTEM_CONFIG }) => {
        ...
        <div className="p-6">
           {step === 'upload' && (
               <div className="flex flex-col items-center justify-center border-2 border-dashed border-gray-300 rounded-lg p-12 bg-gray-50 hover:bg-white transition-colors">
                  ...
                  <p className="text-xs text-gray-400 mt-2 hover:underline cursor-help" title="Rumah Sukan, Tahun, Jantina, Acara, Nama Peserta, Kelas">Format: Rumah, Tahun, Jantina, Acara, Nama, Kelas</p>
                  ...
                  <div className="mt-8 bg-blue-50/50 text-blue-800 p-4 rounded-xl border border-blue-100 text-sm max-w-lg text-center shadow-sm">
                     <b className="block mb-1 text-blue-900">ℹ️ Info Tambahan:</b>
               ...
               <div className="animate-fadeIn space-y-6">
                   <div className="bg-orange-50 border border-orange-200 p-4 rounded-xl text-orange-900">
                      ...
                      <p className="text-sm">
                          ...
                          Peserta yang tidak ditanda <b>(✓)</b> akan dibuang dari senarai acara ini.
                      </p>
                   </div>
